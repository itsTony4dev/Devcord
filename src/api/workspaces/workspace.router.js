 ...
 *               $ref: '#/components/schemas/Error'
 *       403:
 *         description: Forbidden - No permission to invite
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/:id/invite', auth, sendWorkspaceInvite);
 ...
 *         schema:
 *           type: string
 *         description: Invite code for the workspace
 *     responses:
 *       201:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/join/:inviteCode', auth, joinWorkspace);
